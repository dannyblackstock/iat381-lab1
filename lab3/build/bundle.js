...
var menuItems = [
  // inject:menuitems
  { payload: 'home', text: 'lab3-app' },
  { payload: 'test', text: 'page' },
  // endinject
];
...
var routes = (
  React.createElement(Route, {name: "app", path: "/", handler: Master}, 
    ...
    React.createElement(Route, {name: "test", handler: TestPage}), 
    /* endinject */
...
},{"./pages/HomePage":313,"./pages/TestPage":314,"material-ui":69,"react":311,"react-router":112,"react-tap-event-plugin":149}],2:[function(require,module,exports){
...
var React = require('react');
var NewView = require('../../views/NewviewView/index.js');
...
module.exports = React.createClass({displayName: "exports",
  render: function () {
    return (
      React.createElement("div", {className: "test-page"}, 
        "Test page ", React.createElement(NewView, null)
      )
    );
  }
...
},{"../../views/NewviewView/index.js":315,"react":311}],315:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function () {
    return (
      React.createElement("div", {className: "newview-view"}, 
        "New Test View!"
      )
    );
  }
